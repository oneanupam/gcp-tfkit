...
data "google_compute_image" "dev_custom_rhel_7" {
  ...
  name    = "rhel-7-v20200403" # google_compute_image.dev_machineimage01[0].name    # "rhel-7-v20200403" # "fdn-dev-mi-01"
  project = "rhel-cloud" # google_compute_image.dev_machineimage01[0].project #       # "agile-antler-321814"
